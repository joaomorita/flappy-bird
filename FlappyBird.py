...
class Passaro:
    ...
    def desenhar(self, tela):
        # definir qual imagem do passaro sera usada
        ...
        # se o passario estiver caindo não vai bater asa
        if self.angulo <= -80:
            self.imagem = self.IMGS[1]
        ...
        retangulo = imagem_ratacionada.get_rect(center=pos_centro_imagem)
    ...
    # interação com usuario
        ...
        for i, passaro in enumerate(passaros):
            ...
            if ai_jogando:
                ...
                output = redes[i].activate((passaro.y, abs(passaro.y - canos[indice_cano].altura),
